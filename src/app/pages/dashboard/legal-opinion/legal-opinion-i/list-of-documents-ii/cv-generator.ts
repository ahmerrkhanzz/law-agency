...
export class DocumentCreator {
    ...
    public create([experiences, educations, beforeTransactions, afterTransactions, intro]): Document {
        ...
        document.addSection({
            children: [
                ...
                this.createSubHeading(
                    "Proof Of Ownership/List Of Title Documents Reviewed:"
                ),
                ...educations
                    .map((education) => {
                        const arr: Paragraph[] = [];
                    ...
                    .reduce((prev, curr) => prev.concat(curr), []),
                this.createSubHeading("Legal Opinion"),
                new Paragraph({
                    style: "wellSpaced",
                    children: [
                        new TextRun({
                            text: experiences[0].summary,
                            font: {
                                name: "Bookman Old Style",
                            },
                            style: "wellSpaced",
                ...
                this.createSubHeading("DOCUMENTS REQUIRED BEFORE TRANSACTION."),
                ...beforeTransactions
                    .map((education) => {
                        const arr: Paragraph[] = [];
                        // arr.push(
                    ...
                    .reduce((prev, curr) => prev.concat(curr), []),
                this.createSubHeading("DOCUMENTS TO BE PROVIDED AFTER TRANSACTION"),
                ...afterTransactions
                    .map((education) => {
                        const arr: Paragraph[] = [];
                        // arr.push(
