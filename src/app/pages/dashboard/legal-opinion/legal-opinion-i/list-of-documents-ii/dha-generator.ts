...
export class DHADocumentCreator {
  // tslint:disable-next-line: typedef
  public create([
    dha_experiences,
    dha_educations,
    dha_beforeTransactions,
    intro,
  ]): Document {
    ...
    document.addSection({
      children: [
        ...
        this.createSubHeading('List Of Documents Reviewed:'),
        ...dha_educations
          .map(education => {
            const arr: Paragraph[] = [];
        ...
        new Paragraph({
          ...
          children: [
            new TextRun({
              text: dha_experiences[0].summary,
              font: {
                name: 'Bookman Old Style',
              },
              style: 'wellSpaced',
        ...
        this.createSubHeading(
          'DOCUMENTS REQUIRED / EXECUTED AT THE TIME OF STAGE-II'
        ),
        ...dha_beforeTransactions
          .map(education => {
            const arr: Paragraph[] = [];
